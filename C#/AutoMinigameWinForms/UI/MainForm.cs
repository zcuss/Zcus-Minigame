...
public sealed class MainForm : Form
{
    ...
    private void Loop()
    {
        ...
        var hasRelaxedOverlapSignal = result.Overlap && isKeyOk && scoreOk && keyStable && marginOk;
